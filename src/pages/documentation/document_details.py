...
def display_documentation():
    ...
    if documentation_section == "Introduction":
        ...
        3. Use Docker to containerize and deploy the data analysis module.
        4. Train the model using the provided scripts (e.g., `train.py`).
        5. Evaluate using `eval.py` and visualize results.
        """)
        st.write("""
        Detailed instructions for each task are documented in the respective sections.
        For any issues, please refer to the troubleshooting section in the repository's README file.
        """)
